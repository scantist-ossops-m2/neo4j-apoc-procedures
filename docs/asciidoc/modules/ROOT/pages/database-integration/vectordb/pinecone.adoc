...
// TODO - riportare l'esempio della issue https://github.com/neo4j-contrib/neo4j-apoc-procedures/issues/4091, 
//  ma mettendo apoc.vectordb.pinecone.query invece di apoc.vectordb.qdrant.query
// dicendo "si possono utilizzare i vectordb insieme alla apoc.ml.rag, eseguendo una query come segue" 
